...
def setup_main_window(role):
    ...
    # Показываем главное окно. Вместо deiconify(), который работает в паре с withdraw(),
    # мы просто устанавливаем нормальную геометрию, что возвращает окно из-за пределов экрана.
    # Для администратора и супервизора геометрия будет установлена ниже,
